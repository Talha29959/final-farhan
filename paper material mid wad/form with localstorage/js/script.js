/* Question 3 - Part-01 : return the scholarship percentage from the function below on the base of CGPA accordingly */
/* write code in
...
function getStudents() {
    ...
    var studentsString = localStorage.getItem('student');
...
function addStudent() {
    ...
    if(!isAlreadyExists(students, regNo)) {
        ...
        localStorage.setItem('student', JSON.stringify(students));  //save on localstorage
    }else {
