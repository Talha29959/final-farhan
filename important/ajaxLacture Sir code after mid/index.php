                        ...
                        <form class="form-inline">
                            <div class="input-group">
                                <input type="search" class="form-control"
                                       ...
                                       placeholder="Find Mobile Phones, Laptops, and more.." onkeyup="getSearchResults(this.value)">
...
<script>
    ...
    function getSearchResults(str) 
    {
        ...
        xmlhttp.open("GET", "get_searched_products.php?e=" + str, true);
        xmlhttp.send();
    }
    
    getSearchResults("displayAll");
</script>
</body>
</html>